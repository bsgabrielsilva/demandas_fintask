...
class Demandas(TimestampsAbstract, models.Model):
    ...
    status = models.CharField('Status de Finalização', max_length=20, choices=demandas_choices(), default="Aberta")
    ...
    celular = models.CharField('Celular', max_length=16, null=False)
